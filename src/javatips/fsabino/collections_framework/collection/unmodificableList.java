package javatips.fsabino.collections_framework.collection;
...
public class unmodificableList {
    ...
    public static void main(String[] args) {
         ...
         *             at javatips.fsabino.collections_framework.collection.unmodificableList.main(unmodificableList.java:12)
         */
